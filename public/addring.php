...
<section class="wrapper">
    ...
    <div class="header-breadcrumbs">
        <div>
            ...
            <span>/</span>
            <a class="active-page" href="/editringprices.php">Nieuwe ring toevoegen</a>
        </div>
    ...
    <h1 class="header-titles top">Nieuwe ring toevoegen</h1>
    ...
    <div class="price-card">
        <form method="POST">
            ...
            <div class="form-group">
                <label class="price-title" for="price">Prijs ring</label>
